...
/*   Updated: 2020/07/09 14:45:12 by trabut           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
					...
					float center_x, float center_y)
{
	...
	while (i < nbr_walls)
	{
		if ((((float)walls[i].a.y > center_y) != ((float)walls[j].a.y >
		center_y)) && (center_x < ((float)walls[j].a.x -
		(float)walls[i].a.x) * (center_y - (float)walls[i].a.y) /
